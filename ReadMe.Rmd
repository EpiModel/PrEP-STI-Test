# HIV and STI Screening among Men who Have Sex with Men
...
We investigate whether PrEP use leads to increased HIV and all-site STI testing, and if there are differences by geography, demographics, or risk behavior. Among MSM who are currently using PrEP, we want to understand if providers are adhering to Centers for Disease Control and Prevention Guidelines for PrEP, which recommends testing for asymptomatic STIs every 3-6 months through the collection of pharyngeal, rectal, and urine specimens.
